...
pub trait DayLoadDraw {
    ...
    fn tik(&self) -> Vec<f32> {
        ...
        //vec![-10f32, 0f32, 10f32, 20f32, 30f32, 40f32, 50f32]
    ...
    fn draw_prof(&self) -> Result<Vec<u8>, String> {
        ...
        draw_text_mut(&mut image, blk, 20, 12, sc2, &font, "MW");
        ...
        draw_line_segment_mut(&mut image, (x1, y1), (x2, y2), gr3);
        ...
        for (di, v) in lpv.iter().enumerate() {
            ...
            draw_line_segment_mut(&mut image, (xi, yi), (x2, yi), blu);
        }
        // show data
